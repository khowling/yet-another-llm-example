                ...
                <div class="sm:px-16 px-4 mb-6 mt-4 w-full">
                    ...
                    <form class="w-full" autocomplete="off" {...{ 'hx-on::after-request': 'this.reset()' }} hx-post="/api/chat/request" hx-target="#messages" hx-swap="beforebegin show:bottom">   
                        ...
                        <div class="relative  w-full">
                            ...
                            <button type="button" class="absolute end-5 bottom-2.5 btn bg-[#0006CF] text-white min-h-fit h-auto p-2" hx-trigger="click" hx-get="/help" hx-target="#messages" hx-swap="beforebegin show:bottom">/help</button>
